...
rule capability_inflation_generic{
    ...
    meta:
        author = "Cisco"
        title = "Capability Inflation Detection"
        title_zh = "能力夸大检测"
        description = "Detects protocol manipulation via capability inflation in skill discovery"
        description_zh = "检测通过能力夸大操纵技能发现流程的协议滥用模式"
        remediation = "Review skill descriptions and remove coercive priority, keyword stuffing, or misleading capability claims."
        remediation_zh = "审查技能描述，移除强制优先级、关键词堆砌或误导性能力声明。"
