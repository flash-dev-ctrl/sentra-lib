...
rule script_injection_generic{
    ...
    meta:
        author = "Cisco"
        title = "Script Injection Detection"
        title_zh = "脚本注入检测"
        description = "Detects malicious script injection patterns in agent skills"
        description_zh = "检测代理技能中的恶意脚本注入模式"
        remediation = "Escape untrusted data in script contexts and avoid dynamic script construction."
        remediation_zh = "在脚本上下文中转义不可信数据，并避免动态构造脚本。"
