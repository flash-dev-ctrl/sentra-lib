...
rule system_manipulation_generic{
    ...
    meta:
        author = "Cisco"
        title = "System Manipulation Detection"
        title_zh = "系统篡改检测"
        description = "Detects system manipulation, privilege escalation, and destructive file operations"
        description_zh = "检测系统篡改、权限提升和破坏性文件操作模式"
        remediation = "Restrict privileged operations and require explicit approval for destructive system changes."
        remediation_zh = "限制特权操作，并要求破坏性系统变更必须经过明确批准。"
